...
def _write_metrics_for_projects(projects, all_builds, data_presenter: DataPresenter):
...
def _output_build_commit_metrics(data_presenter: DataPresenter, project, response):
